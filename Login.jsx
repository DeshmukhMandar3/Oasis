...
let userulr='http://localhost:8080/user'
...
const getregisterdata=async(obj)=>{
      setlading(false)
  try {
      let resdata=await axios.get("http://localhost:8080/register") 
...
const postregisterdata=async(obj)=>{
      try {
            let registerdatas=await axios.post("http://localhost:8080/register",obj)
            toast({
...
const postuserdatadata=async(obj)=>{
      ...
      try {
            let userdatas=await axios.post("http://localhost:8080/user",obj)
            console.log('usedta')
