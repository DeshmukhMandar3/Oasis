...
const Login = () => {
  ...
  const getregisterdata = async (obj) => {
    ...
    try {
      let resdata = await axios.get(
        "https://backend-cw-4.onrender.com/register"
      );
  ...
  const postregisterdata = async (obj) => {
    try {
      let registerdatas = await axios.post(
        "https://backend-cw-4.onrender.com/register",
        obj
      );
      toast({
  ...
  const postuserdatadata = async (obj) => {
    try {
      let userdatas = await axios.post(
        "https://backend-cw-4.onrender.com/user",
        obj
      );
      console.log("usedta");
    } catch (error) {
            ...
            >
              ...
              >
                <GridItem colSpan={2} bg="#eff7fa">
                  <Box m="auto" mt="20%">
                    <Image
                      ...
                      h="40%"
                      m="auto"
                      src="http://cdn.onlinewebfonts.com/svg/img_460661.png"
                    />
                    <Text
                      textAlign={"center"}
                      fontSize="19px"
                  ...
                  <Box m="auto" mt="20%">
                    <Image
                      ...
                      h="40%"
                      m="auto"
                      src="https://static.thenounproject.com/png/237693-200.png"
                    />
                    <Text
                      textAlign={"center"}
                      fontSize="19px"
                  ...
                  <Box m="auto" mt="20%" mb="20%">
                    <Image
                      ...
                      h="40%"
                      m="auto"
                      src="http://cdn.onlinewebfonts.com/svg/img_60755.png"
                    />
                    <Text
                      textAlign={"center"}
                      fontSize="19px"
                ...
                {backpage ? (
                          ...
                          <TabPanel display={"block"}>
                            <Box mt="5%">
                              <Input
                                ...
                                type={"text"}
                                value={verfiyemail}
                                onChange={(e) => setverfiyemail(e.target.value)}
                            ...
                            <Box mt="7%">
                              ...
                              <Box mt="3%" display={"flex"} gap="30px">
                                ...
                                <Image
                                  w="10%"
                                  src="https://img.freepik.com/free-icon/google_318-278809.jpg?w=2000"
                                />
                              </Box>
                            </Box>
                          </TabPanel>
                          <TabPanel>
                            ...
                            <Box mt="3%" display={"flex"}>
                              ...
                              <Box ml="1%">
                                ...
                                <Text fontSize={"13px"}>
                                  By Registering you accept our User Agreement
                                  and Privacy Policy
                                </Text>
                              </Box>
                            </Box>
                  ...
                  <GridItem colSpan={6} bg="white">
                    <Box>
                      <Button bg="none" onClick={backpagedatas}>
                        <ChevronLeftIcon />
                        Back
                      </Button>
                    </Box>
                    <Box ml="20px">
                      ...
                      <Box display={"flex"}>
                        ...
                        <Text ml="5px" fontWeight={"bold"} fontSize={"17px"}>
                          {email}
                        </Text>
                      </Box>
                      <Box>
                        <Text fontSize={"16px"}>
                          (If OTP is missing in Inbox, please check your spam
                          folder).
                        </Text>
                      </Box>
                      ...
                      >
                        <Box>
                          <Button bg={"#ff5e62"} w="300px" onClick={Verifyopt}>
                            Verify
                          </Button>
                        </Box>
                        <Box mt="1%" ml="25%" color={"#757575"}>
                          {seconds > 0 || minutes > 0 ? (
                            <Box display={"flex"}>
                              <Text>
                                {seconds < 10 ? `0${seconds}` : seconds} Second
                                left
                              </Text>
                              <Image
                                ml={"4%"}
                                w="10%"
                                src="https://cdn1.vectorstock.com/i/1000x1000/31/85/stopwatch-glyph-icon-measure-and-countdown-timer-vector-25053185.jpg"
                              />
                            </Box>
                          ) : (
                            <Text></Text>
