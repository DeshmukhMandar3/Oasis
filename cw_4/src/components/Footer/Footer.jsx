...
<div className="footer_first_section_start">
...
<div class="footer_first_section_start">
...
{/* keep in touch(secons part footer) */}
<div class="footer2_second-section">
        <div class="listlogo_footer_section">
            <div class="social_connection_footer_section">
                <h3>Keep In Touch</h3>
                <ul>
                    <li>
            ...
            <div class="trustedpayment_footer_section_part">
    ...
    {/* footer third part */}
    <div class="footer_third_section_start">
        <div class="footer_category_div_start">
            <h3>Our Leading Categories</h3>
            <ul>
                <li class="footer_third_section_heading">Mobile & Tablets:</li>
            ...
            <ul>
                <li class="footer_third_section_heading">Computers:</li>
                <li> Laptops</li>
                <li> | Printers</li>
                <li> | Routers</li>
            ...
            <ul>
                <li class="footer_third_section_heading">TV, Audio & Large Appliances:</li>
                <li>TVs & DTH</li>
            ...
            <ul>
                <li class="footer_third_section_heading">Mobile &amp; Laptop Accessories:</li>
                <li> Headphones</li>
                <li> | Power Banks</li>
                <li> | Backpacks</li>
            ...
            <ul>
                <li class="footer_third_section_heading">Appliances:</li>
                <li> Trimmers</li>
                <li> | Hair Dryers</li>
            ...
            <ul>
                <li class="footer_third_section_heading">Home & Kitchen:</li>
                <li> Bedsheets</li>
            ...
            <ul>
                <li class="footer_third_section_heading">Fashion:</li>
            ...
            <ul>
                <li class="footer_third_section_heading">Footwear:</li>
            ...
            <ul>
                <li class="footer_third_section_heading">Travel & Luggage:</li>
                <li> Duffle Bags</li>
                <li> | Laptop Bags</li>
            ...
            <ul>
                <li class="footer_third_section_heading">Jewelry & Watches:</li>
                <li> Coins & Bars</li>
                <li> | Men's Watches</li>
            ...
            <ul>
                <li class="footer_third_section_heading">Automotive:</li>
            ...
            <ul>
                <li class="footer_third_section_heading">Toys, Baby &amp; Kids :</li>
                <li> Diapers</li>
            ...
            <ul>
                <li class="footer_third_section_heading">Gourmet & Daily Needs :</li>
            ...
            <ul>
                <li class="footer_third_section_heading">Sports and Health</li>
            ...
            <ul>
                <li class="footer_third_section_heading">Beauty & Perfumes:</li>
            ...
            <ul id="footer_third_setion_offer_part">
    ...
    <div class="footer_forth_section_start">
        <div class="footer_category_div_start">
    ...
    {/* footer fifth part */}
    <div class="footer_fifth_part_start">
        <div class="footer_category_div_start">
            <ul>
            ...
            <div class="footer_last_section_copyright_part">
